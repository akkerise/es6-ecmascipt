...
// console.log(numbers); // return Set{1,2,3,4,5}
// numbers.add([5,34,43,2,5,34]); // truyền vào 1 mảng mới
// console.log(numbers); // Set {1, 2, 3, 4, [5, 34, 43, 2, 5, 34]}
...
//// LƯU Ý : khi chuyển từ array sang set thì nếu có phần tử trùng giá trị thì sẽ chỉ còn 1 phần tử
